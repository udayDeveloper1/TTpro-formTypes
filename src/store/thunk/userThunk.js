...
export const pdfListingApi = createAsyncThunk(
    ...
    async (_, { dispatch, rejectWithValue }) => {
      try {
        const response = await axiosInstance.get(`/api/pdf/transaction-certificates/`);
       console.log(response);
       
       dispatch(setPdfListData(response));
  ...
  export const pdfListingApi2 = createAsyncThunk(
    ...
    async (_, { dispatch, rejectWithValue }) => {
      try {
        const response = await axiosInstance.get(`api/pdf/transaction-certificates-type2/`);
       console.log(response);
       dispatch(setPdfListData2(response));
