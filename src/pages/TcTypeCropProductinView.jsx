          ...
          >
            ...
            <div className='w-full section1 flex flex-wrap justify-between'>
                ...
                <div className='w-full md:w-[49%] flex justify-center  flex-col'>
                  <div className='flex flex-wrap '>
                    <div className='w-full'>
                      ...
                      <div className='flex'>
                        <h4 className='text-xl pe-4 w-[40%]'>Valid till: </h4>
              ...
              <div className='w-full px-2 '>
                <h4 className='text-xl keyName pe-4'>
                  This is to certify that the product and area inspected by
                  Certification body tq cert services private limited are in
                ...
                <table className='w-full border border-collapse'>
                  <thead>
                    <tr>
                      ...
                      <th className='text-left border p-2'>No of Farmers</th>
                    ...
                    {data?.extracted_data?.[
                      ...
                      return (
                        <tr key={ind}>
                          ...
                          <td className='border p-2'>{ele?.no_of_farmers}</td>
            ...
            <div className='w-full section1 pb-4'>
              ...
              <div className='flex flex-wrap p-2'>
                <div className='w-full flex flex-col'>
                  <div className='pb-5'>
                    <h4 className='keyName pe-4 text-xl py-3'> Producer Products: </h4>
                    <table className='w-full border border-collapse '>
                  <thead>
                    <tr>
                      <th className='text-left border p-2'>Season</th>
                      <th className='text-left border p-2'>Product's no</th>
                      <th className='text-left border p-2'>Product(s)</th>
                      <th className='text-left border p-2'>Organic Status</th>
                      <th className='text-left border p-2'>Variety</th>
                      <th className='text-left border p-2'>Crop Type</th>
                      <th className='text-left border p-2'>Area(in Ha.)</th>
                      <th className='text-left border p-2'>Est Quantity in MT</th>
                    </tr>
                  </thead>
                  <tbody>
                    {data?.extracted_data?.[
                      ...
                      return (
                        <tr key={ind}>
                          <td className='border p-2'>{ele?.season}</td>
                          <td className='border p-2'>{ele?.product_s_no}</td>
                          <td className='border p-2'>{ele?.["product(s)"]}</td>
                          <td className='border p-2'>{ele?.organic_status}</td>
                          <td className='border p-2'>{ele?.variety}</td>
                          <td className='border p-2'>{ele?.crop_type}</td>
                          <td className='border p-2'>{ele?.["area(in Ha.)"]}</td>
                          <td className='border p-2'>{ele?.est_quantity_in_MT}</td>
                        </tr>
                      )
                    })}
                  </tbody>
                  ...
                  <div className='pb-5'>
                    <h4 className='keyName pe-4 text-xl py-3'> Approved Farmer List: </h4>
                    <table className='w-full border border-collapse '>
                  <thead>
                    <tr>
                      <th className='text-left border p-2'>State</th>
                      <th className='text-left border p-2'>District</th>
                    ...
                    {data?.extracted_data?.[
                      ...
                      return (
                        <tr key={ind}>
                          ...
                          <td className='border p-2'>{ele?.district}</td>
