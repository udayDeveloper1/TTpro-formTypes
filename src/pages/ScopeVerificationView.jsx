    ...
    <div className="container formList-cont border rounded-xl mx-auto  my-10 ">
      ...
      {console.log(data)}
            ...
            <div className="w-full section1 flex flex-wrap justify-between">
              <h3 className="text-2xl w-full  CertifiedInput p-3">{data?.file_name}</h3>
              <div className="w-full flex p-2 justify-between">
                ...
                <div className="w-full flex flex-col md:w-[49%] justify-center">
                  ...
                  <div className="w-full flex flex-col">
                    ...
                    <h4 className="text-xl keyName pe-4 w-[30%]">{" "}File Name{" "}</h4>
                    <p className="text-xl keyValue w-[70%]">{data?.file_name}</p>
                    </div>
                    <div className="flex">
              ...
              <div className='w-full section1 flex flex-wrap justify-between'>
                <h3 className="text-2xl w-full  CertifiedInput p-3">Scope Certificate</h3>
                <div className="w-full flex p-2 justify-between">
              <div className="w-full flex flex-col md:w-[49%] justify-center">
                  <div className="flex flex-wrap ">
                  <div className="w-full flex flex-col">
                    <div className="flex flex">
                      <h4 className="text-xl keyName pe-4 w-[30%]">{" "}Certificate Number{" "}</h4>
                      <p className="text-xl keyValue w-[70%]">{data?.extracted_data?.['scope_certificate']?.certificate_number}</p>
                    </div>
                    <div className="flex">
                      <h4 className="text-xl keyName pe-4  w-[30%]">Version:{" "}</h4>
                      <p className="text-xl keyValue  w-[70%]">{data?.extracted_data?.['scope_certificate']?.version}</p>
                    </div>
                    <div className="flex">
                      <h4 className="text-xl keyName pe-4  w-[30%]">Date of Issue:{" "}</h4>
                      <p className="text-xl keyValue  w-[70%]">{data?.extracted_data?.['scope_certificate']?.date_of_issue}</p>
                    </div>
                    <div className="flex">
                      <h4 className="text-xl keyName pe-4  w-[30%]">Notes:{" "}</h4>
                      <p className="text-xl keyValue  w-[70%]">{data?.extracted_data?.['scope_certificate']?.additional_notes}</p>
                    </div>
                  </div>
                  </div>
                </div>
                ...
                <div className="w-full md:w-[49%] flex justify-center  flex-col">
                  <div className="flex flex-wrap ">
                    <div className="w-full">
                      <div className="flex">
                        <h4 className="text-xl keyName pe-4 w-[30%]">Holder:{" "}</h4>
                        <p className="text-xl keyValue w-[70%]">{data?.extracted_data?.['scope_certificate']?.holder}</p>
                      </div>
                      <div className="flex">
                        <h4 className="text-xl pe-4 w-[30%]">Certification Body: </h4>
                        <p className="text-xl w-[70%]">{data?.extracted_data?.['scope_certificate']?.certification_body}</p>
                      </div>
                      <div className="flex">
                        <h4 className="text-xl keyName pe-4  w-[30%]">CEO:{" "}</h4>
                        <p className="text-xl keyValue  w-[70%]">{data?.extracted_data?.['scope_certificate']?.ceo_name}</p>
                      </div>
                      <div className="flex">
                      <h4 className="text-xl keyName pe-4  w-[30%]">Address:{" "}</h4>
                      <p className="text-xl keyValue  w-[70%]">{data?.extracted_data?.['scope_certificate']?.address}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full section1 flex flex-wrap">
                <div className="w-full ">
                  <div className="flex flex-wrap">
                    <h3 className="text-2xl w-full  CertifiedInput p-3">Products Appendix</h3>
                    <div className="flex w-full flex-wrap">
                      { data?.extracted_data?.['products_appendix']?.map((product, idx) => {
                        return (
                          <div className="w-full" key={idx}>
                            <h3 className="text-xl pe-2 p-2 pb-0 font-semibold">Product {idx + 1}:</h3>
                                    ...
                                    {Object.keys(product)?.map((element, index) => {
                                      return (
                                          <tr className="bg-gray-100 border-b border-gray-300  ">
                                            ...
                                            <td className="p-1">{product?.[element]}</td>
                                          </tr>
              ...
              <div className='w-full section1 pb-4'>
                <h3 className="text-2xl w-full  CertifiedInput p-3">Site Appendix</h3>
                  <div className="flex flex-wrap p-2">
                  <div className="w-full flex flex-col">
                    <div className="flex flex">
                      <h4 className="keyName pe-4 w-[30%]">{" "}Facility Name{" "}</h4>
                      <p className="keyValue w-[70%]">{data?.extracted_data?.['site_appendix']?.facility_name}</p>
                    </div>
                    <div className="flex">
                      <h4 className="keyName pe-4  w-[30%]">Address:{" "}</h4>
                      <p className="keyValue  w-[70%]">{data?.extracted_data?.['site_appendix']?.address}</p>
                    </div>
                    <div className="flex">
                      <h4 className="keyName pe-4  w-[30%]">Process Categories:{" "}</h4>
                      <p className="keyValue  w-[70%]">{data?.extracted_data?.['site_appendix']?.process_categories?.join(', ')}</p>
                    </div>
                  </div>
                  </div>
              </div>
              ...
              <div className="w-full section1 flex flex-wrap">
                <div className="w-full ">
                  <div className="flex flex-wrap">
                    <h3 className="text-2xl w-full  CertifiedInput p-3">Subcontractors</h3>
                    <div className="flex w-full flex-wrap">
                      { data?.extracted_data?.['independently_certified_subcontractor_appendix']?.map((subcontractor, idx) => {
                        return (
                          <div className="w-full" key={idx}>
                            <h3 className="text-xl pe-2 p-2 pb-0 font-semibold">Subcontractor {idx + 1}:</h3>
                            <div className="p-3 overflow-x-auto">
                                <table className="w-full border border-gray-300 text-left">
                                  <tbody>
                                    {Object.keys(subcontractor)?.map((element, index) => {
                                      return (
                                          <tr className="bg-gray-100 border-b border-gray-300  ">
                                            <td className="p-1 font-medium py-3">
                                              {element}
                                            ...
                                            <td className="p-1">
                            {Array.isArray(subcontractor?.[element])
