...
const ImportPdfScopeVerification = () => {
  ...
  const handleResponse = response => {
    ...
    form2.setFieldsValue({
      ...
      independently_certified_subcontractor_appendix:
        independently_certified_subcontractor_appendix.map(subcontractor => ({
            ...
            >
              ...
              <div className='product-item border border-gray-300 rounded-md p-4 mb-4'>
                ...
                <div className='flex flex-wrap -mx-2'>
                  ...
                  >
                    <DatePicker
                      className='w-full datePickerIpnut'
                      format='DD/MM/YYYY'
                    />
                  </AntdForm.Item>
                  <AntdForm.Item
              ...
              <div className='product-item border border-gray-300 rounded-md p-4 mb-4'>
                <div className='flex flex-wrap -mx-2'>
                  ...
                  <div>
                    <AntdForm.List
                      name={['site_appendix', 'process_categories']}
                    >
                      {(fields, { add, remove }) => (
              ...
              <h3 className='text-xl font-semibold mb-4'>
                4. Independently Certified Subcontractor Appendix
              </h3>
                        ...
                        <div className='flex flex-wrap -mx-2'>
                          ...
                          <AntdForm.List name={[name, 'process_categories']}>
                            {(
                              ...
                              {
                                add: addProcessCategory,
                                remove: removeProcessCategory
                              }
                            ) => (
                              <>
                                    ...
                                    >
                                      <AntdForm.Item
                                        ...
                                        rules={[
                                          {
                                            required: true,
                                            message: 'Enter Process Category'
                                          }
                                        ]}
                                        style={{ flex: 1 }}
                                      >
